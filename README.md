...
```powershell
Install-Module VMware.PowerCLI, PowerRvB
```
...
Connect-VIServer elsa.sdc.cpp -User <Username> -Password <Password>

# Note: Passwords with symbols may not work without being enclosed with ''
Connect-VIServer elsa.sdc.cpp -User tswift -Password 'Thanus$Password'
```
...
```powershell
New-DevPod -Name <vAppName> -Target <ResourcePoolName> -CreateRouter <$true|$false> -WanPortGroup <PortGroupName>

New-DevPod -Name EvansDevPod3 -Target 02-07_Evan -CreateRouter $true -WanPortGroup 0010_DefaultNetwork
```
...
```powershell
Invoke-RvByeBye -Tag <Tag>
Invoke-RvByeBye -Tag RvB
```
...
```powershell
New-DevPod -Name EvansPod -Target 02-07_Evan
```
...
```powershell
New-DevPod -Name EvansPod -Target 02-07_Evan -CreateRouter $true -WanPortGroup 0010_DefaultNetwork
```
...
```powershell
Invoke-RvByeBye -Tag 'Spring RvB 2022'
```
